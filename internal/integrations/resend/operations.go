...
func New(cfg config.ResendConfig, httpClient HTTPClient) *Client {
	if httpClient == nil {
...
func (c *Client) Execute(ctx context.Context, operation string, _ json.RawMessage, params json.RawMessage, _ event.Event) (outbound.Result, error) {
